...
|---|---|---|
| **[Customer Churn Analysis](customer-churn-analysis)** | Diagnoses a **26.5%** telecom churn rate, finds the high-risk segments, and quantifies **~$1.67M/yr** of revenue at risk — with a retention plan. | Python · pandas · seaborn · scikit-learn |
| **[Sales & Revenue Dashboard](sales-revenue-dashboard)** | Superstore sales analytics: a back-tested forecast, profit-leakage detection, and anomaly flagging. | Python · pandas · statsmodels |
